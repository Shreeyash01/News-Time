  ...
  atricles = [
    {
      ...
      "content": "The build-up to Christmas for England's women is slightly different - and warmer - to usual. They played the last game of their eight-match series against the West Indies on 22 December, and arrive… [+5362 chars]"
    },
    {
      "source": {
        "id": "espn-cric-info",
    ...
    return (
      <div>
        <div className="card" style={{ width: "18rem" }}>
          <img src={imgUrl} className="card-img-top" alt="newsImg" />
